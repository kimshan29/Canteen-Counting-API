declare module 'sweetalert2' {
    ...
    namespace Swal {
        ...
        /**
         * Provide an array of SweetAlert2 parameters to show multiple modal, one modal after another.
         *
    ...
    export interface SweetAlertOptions {
        ...
        /**
         * Useful for those who are using SweetAlert2 along with Bootstrap modal.
         * By default keydownListenerCapture is false which means when a user hits Esc,
         * both SweetAlert2 and Bootstrap modal will be closed.
